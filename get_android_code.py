...
code_base_url = "http://crypto.nknu.edu.tw/AOSP/Android6/"

file_types = ['href="(.+?\.c)"', 'href="(.+?\.cpp)"','href="(.+?\.h)"', 'href="(.+?\.mk)"']



def get_url_files(code_url, local_addr):
	n = 0
	...
	for pattern in file_types:
		#print pattern
		file_names = re.findall(pattern, index_content)
...
code_url = code_base_url + sys.argv[1]

print "Now, get code from: " + code_url

num = get_url_files(code_url, sys.argv[1])
